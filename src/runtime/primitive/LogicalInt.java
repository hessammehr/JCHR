...
public class LogicalInt implements BuiltInConstraintObservable, HashObservable {
    ...
    protected LogicalInt parent = this;
    ...
    @JCHR_Declare
    public LogicalInt(String name) {
        this.name = name;
    }
    
    @JCHR_Init
    public LogicalInt(int value) {
        this.value = value;
        this.hasValue = true;
    }

    @JCHR_Init( identifier = 0 )
    public LogicalInt(String name, int value) {
        this.name = name;
        this.value = value;
        this.hasValue = true;
    }
    ...
    public String toString() {
        ...
        if (!found.hasValue)
            ...
            return String.valueOf(found.value);
    }
}