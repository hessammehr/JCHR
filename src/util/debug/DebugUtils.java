...
public abstract class DebugUtils {
    ...
    public static void printCaller(int goBack) {
        System.err.println(getCaller(goBack + 2));
    }
    ...
    /**
     * Just a poor man's debug tool for command-line based applications:
     * waits until the user inputs something from the &quot;standard&quot;
     * input stream.
     * 
     * @see System#in
     */
